...
$Session = New-PSSession -ConfigurationName Microsoft.Exchange -ConnectionUri http://exchms.coordinatingcenter.org/PowerShell/ -Authentication Kerberos -Credential $Creds
...
$From = "issupport@coordinatingcenter.org"
$To = $ManagerEmail
$Subject = "Setting Users out of Office Message"
$Body = "
Dear $Managers, 
To setup the out of office message for $Users, go to https://mail.coordinatingcenter.org/owa and sign in using your username and password,
...
IS Support
"
Send-MailMessage -to $To -From $From -Subject $Subject -Body $Body -SmtpServer mail.coordinatingcenter.org -Priority High